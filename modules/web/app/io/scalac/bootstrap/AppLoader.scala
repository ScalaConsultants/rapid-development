...
import io.scalac.common.services.{Clock, DatabaseHealthCheck, HealthCheckServicesImpl, NoopServiceProfiler}
import io.scalac.controllers.{NotesController, PagesController}
import io.scalac.common.db.{DBExecutor, PostgresJdbcProfile}
import io.scalac.domain.dao.{SlickNotesDao, SlickUsersDao}
import io.scalac.domain.entities.{NotesSlickPostgresRepository, UsersSlickPostgresRepository}
...
class MyComponents(context: Context)
  ...
  val clock = Clock(DateTimeZone.UTC)
