...
import io.scalac.domain.mock.MerchantsDaoMock
...
//class MerchantsServicesSpecs extends BaseUnitTest {
//
//  "NotesService.find" should {
//    "return successful response" when {
//      "no note has been found for given id" in new Fixture {
//        override def notesDao: MerchantsDaoMock = new MerchantsDaoMock() {
...
//    val outgoingNote = OutgoingMerchant(dbNote.id.get, dbNote.creator, dbNote.note, dbNote.updatedAt)
//    val pagination = Pagination(limit = 10, offset = 0)
//
//    def notesDao: MerchantsDaoMock
//
//    val notesService = new DefaultMerchantsService(notesDao)
//  }
//}
